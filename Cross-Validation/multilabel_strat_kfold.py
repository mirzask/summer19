...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Applies Multilabel Stratified K-fold cross validation using iterative stratification. Adds a 'kfold' column to the provided CSV file."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Column name in CSV file that contains labels.",
    )
    ...
    # Initiate K-fold
    kf = MultilabelStratifiedKFold(n_splits=args.num_folds)
